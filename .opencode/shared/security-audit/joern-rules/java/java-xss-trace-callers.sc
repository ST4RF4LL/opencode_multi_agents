...
// Original entry: @main def exec(cpgFile: String, sinkMethod: String = ".*PrintWriter\\.print.*")
// Do not call importCpg; use the ambient `cpg` symbol.
// Extra param default inlined: sinkMethod: String = ".*PrintWriter\\.print.*"

val sinkMethod = ".*PrintWriter\\.print.*"
