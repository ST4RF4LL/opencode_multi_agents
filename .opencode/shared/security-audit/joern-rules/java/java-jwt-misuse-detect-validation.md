# java-jwt-misuse-detect-validation

- **language**: java
- **skill**: `java-jwt-misuse`
- **weakness**: `jwt-misuse`
- **dimension**: D2
- **source_script**: `skills/java-subagent/java-jwt-misuse/rules/joern/detect-validation.sc`
...
2. `joern <cpg.bin> --script .opencode/shared/security-audit/joern-rules/java/java-jwt-misuse-detect-validation.sc`.
