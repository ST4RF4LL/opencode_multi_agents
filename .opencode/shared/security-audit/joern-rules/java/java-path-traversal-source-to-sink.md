# java-path-traversal-source-to-sink

- **language**: java
- **skill**: `java-path-traversal`
- **weakness**: `path-traversal`
- **dimension**: D5
- **source_script**: `skills/java-subagent/java-path-traversal/rules/joern/source-to-sink.sc`
...
2. `joern <cpg.bin> --script .opencode/shared/security-audit/joern-rules/java/java-path-traversal-source-to-sink.sc`.
