# java-spel-injection-trace-callers

- **language**: java
- **skill**: `java-spel-injection`
- **weakness**: `spel-injection`
- **dimension**: D1
- **source_script**: `skills/java-subagent/java-spel-injection/rules/joern/trace-callers.sc`
...
2. `joern <cpg.bin> --script .opencode/shared/security-audit/joern-rules/java/java-spel-injection-trace-callers.sc`.
