# java-sql-injection-derived-map-key-to-sql

- **language**: java
- **skill**: `java-sql-injection`
- **weakness**: `sql-injection`
- **dimension**: D1
- **source_script**: `skills/java-subagent/java-sql-injection/rules/joern/derived/map-key-to-sql.sc`
...
2. `joern <cpg.bin> --script .opencode/shared/security-audit/joern-rules/java/java-sql-injection-derived-map-key-to-sql.sc`.
