# java-idor-locate-sinks

- **language**: java
- **skill**: `java-idor`
- **weakness**: `idor`
- **dimension**: D3
- **source_script**: `skills/java-subagent/java-idor/rules/joern/locate-sinks.sc`
...
2. `joern <cpg.bin> --script .opencode/shared/security-audit/joern-rules/java/java-idor-locate-sinks.sc`.
