# java-deserialization-locate-sources

- **language**: java
- **skill**: `java-deserialization`
- **weakness**: `deserialization`
- **dimension**: D4
- **source_script**: `skills/java-subagent/java-deserialization/rules/joern/locate-sources.sc`
...
2. `joern <cpg.bin> --script .opencode/shared/security-audit/joern-rules/java/java-deserialization-locate-sources.sc`.
