# java-ldap-injection-source-to-sink

- **language**: java
- **skill**: `java-ldap-injection`
- **weakness**: `ldap-injection`
- **dimension**: D1
- **source_script**: `skills/java-subagent/java-ldap-injection/rules/joern/source-to-sink.sc`
...
2. `joern <cpg.bin> --script .opencode/shared/security-audit/joern-rules/java/java-ldap-injection-source-to-sink.sc`.
