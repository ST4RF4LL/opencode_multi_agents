# java-idor-source-to-sink

- **language**: java
- **skill**: `java-idor`
- **weakness**: `idor`
- **dimension**: D3
- **source_script**: `skills/java-subagent/java-idor/rules/joern/source-to-sink.sc`
...
2. `joern <cpg.bin> --script .opencode/shared/security-audit/joern-rules/java/java-idor-source-to-sink.sc`.
