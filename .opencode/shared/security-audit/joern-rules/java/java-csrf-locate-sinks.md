# java-csrf-locate-sinks

- **language**: java
- **skill**: `java-csrf`
- **weakness**: `csrf`
- **dimension**: D2
- **source_script**: `skills/java-subagent/java-csrf/rules/joern/locate-sinks.sc`
...
2. `joern <cpg.bin> --script .opencode/shared/security-audit/joern-rules/java/java-csrf-locate-sinks.sc`.
