// Locate common external object-id sources for Java web apps (IDOR).
...
val annotated = cpg.parameter
  .where(_.annotation.name("PathVariable|RequestParam|RequestHeader|RequestBody|CookieValue|ModelAttribute"))
  .l
