# java-deserialization-source-to-sink

- **language**: java
- **skill**: `java-deserialization`
- **weakness**: `deserialization`
- **dimension**: D4
- **source_script**: `skills/java-subagent/java-deserialization/rules/joern/source-to-sink.sc`
...
2. `joern <cpg.bin> --script .opencode/shared/security-audit/joern-rules/java/java-deserialization-source-to-sink.sc`.
