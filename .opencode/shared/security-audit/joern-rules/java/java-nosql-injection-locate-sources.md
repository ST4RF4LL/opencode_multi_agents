# java-nosql-injection-locate-sources

- **language**: java
- **skill**: `java-nosql-injection`
- **weakness**: `nosql-injection`
- **dimension**: D1
- **source_script**: `skills/java-subagent/java-nosql-injection/rules/joern/locate-sources.sc`
...
2. `joern <cpg.bin> --script .opencode/shared/security-audit/joern-rules/java/java-nosql-injection-locate-sources.sc`.
