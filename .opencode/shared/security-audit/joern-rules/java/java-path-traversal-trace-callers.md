# java-path-traversal-trace-callers

- **language**: java
- **skill**: `java-path-traversal`
- **weakness**: `path-traversal`
- **dimension**: D5
- **source_script**: `skills/java-subagent/java-path-traversal/rules/joern/trace-callers.sc`
...
2. `joern <cpg.bin> --script .opencode/shared/security-audit/joern-rules/java/java-path-traversal-trace-callers.sc`.
