# java-path-traversal-locate-sources

- **language**: java
- **skill**: `java-path-traversal`
- **weakness**: `path-traversal`
- **dimension**: D5
- **source_script**: `skills/java-subagent/java-path-traversal/rules/joern/locate-sources.sc`
...
2. `joern <cpg.bin> --script .opencode/shared/security-audit/joern-rules/java/java-path-traversal-locate-sources.sc`.
