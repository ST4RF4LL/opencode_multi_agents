...
// Original entry: @main def exec(cpgFile: String, sinkMethod: String = ".*DirContext\\.search.*")
// Do not call importCpg; use the ambient `cpg` symbol.
// Extra param default inlined: sinkMethod: String = ".*DirContext\\.search.*"

val sinkMethod = ".*DirContext\\.search.*"
