# java-file-upload-locate-sinks

- **language**: java
- **skill**: `java-file-upload`
- **weakness**: `file-upload`
- **dimension**: D5
- **source_script**: `skills/java-subagent/java-file-upload/rules/joern/locate-sinks.sc`
...
2. `joern <cpg.bin> --script .opencode/shared/security-audit/joern-rules/java/java-file-upload-locate-sinks.sc`.
