# java-command-injection-source-to-sink

- **language**: java
- **skill**: `java-command-injection`
- **weakness**: `command-injection`
- **dimension**: D1
- **source_script**: `skills/java-subagent/java-command-injection/rules/joern/source-to-sink.sc`
...
2. `joern <cpg.bin> --script .opencode/shared/security-audit/joern-rules/java/java-command-injection-source-to-sink.sc`.
