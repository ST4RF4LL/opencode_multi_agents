# java-open-redirect-detect-validation

- **language**: java
- **skill**: `java-open-redirect`
- **weakness**: `open-redirect`
- **dimension**: D6
- **source_script**: `skills/java-subagent/java-open-redirect/rules/joern/detect-validation.sc`
...
2. `joern <cpg.bin> --script .opencode/shared/security-audit/joern-rules/java/java-open-redirect-detect-validation.sc`.
