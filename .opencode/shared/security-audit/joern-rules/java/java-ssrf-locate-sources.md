# java-ssrf-locate-sources

- **language**: java
- **skill**: `java-ssrf`
- **weakness**: `ssrf`
- **dimension**: D6
- **source_script**: `skills/java-subagent/java-ssrf/rules/joern/locate-sources.sc`
...
2. `joern <cpg.bin> --script .opencode/shared/security-audit/joern-rules/java/java-ssrf-locate-sources.sc`.
