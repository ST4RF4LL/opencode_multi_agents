# java-log-injection-detect-validation

- **language**: java
- **skill**: `java-log-injection`
- **weakness**: `log-injection`
- **dimension**: D8
- **source_script**: `skills/java-subagent/java-log-injection/rules/joern/detect-validation.sc`
...
2. `joern <cpg.bin> --script .opencode/shared/security-audit/joern-rules/java/java-log-injection-detect-validation.sc`.
