# java-hardcoded-secrets-locate-sinks

- **language**: java
- **skill**: `java-hardcoded-secrets`
- **weakness**: `hardcoded-secrets`
- **dimension**: D8
- **source_script**: `skills/java-subagent/java-hardcoded-secrets/rules/joern/locate-sinks.sc`
...
2. `joern <cpg.bin> --script .opencode/shared/security-audit/joern-rules/java/java-hardcoded-secrets-locate-sinks.sc`.
