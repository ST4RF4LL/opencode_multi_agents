# java-file-upload-detect-validation

- **language**: java
- **skill**: `java-file-upload`
- **weakness**: `file-upload`
- **dimension**: D5
- **source_script**: `skills/java-subagent/java-file-upload/rules/joern/detect-validation.sc`
...
2. `joern <cpg.bin> --script .opencode/shared/security-audit/joern-rules/java/java-file-upload-detect-validation.sc`.
