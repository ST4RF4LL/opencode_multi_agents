# java-sql-injection-derived-operator-connector-inject

- **language**: java
- **skill**: `java-sql-injection`
- **weakness**: `sql-injection`
- **dimension**: D1
- **source_script**: `skills/java-subagent/java-sql-injection/rules/joern/derived/operator-connector-inject.sc`
...
2. `joern <cpg.bin> --script .opencode/shared/security-audit/joern-rules/java/java-sql-injection-derived-operator-connector-inject.sc`.
