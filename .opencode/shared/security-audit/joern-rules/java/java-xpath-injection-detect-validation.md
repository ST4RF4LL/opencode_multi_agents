# java-xpath-injection-detect-validation

- **language**: java
- **skill**: `java-xpath-injection`
- **weakness**: `xpath-injection`
- **dimension**: D1
- **source_script**: `skills/java-subagent/java-xpath-injection/rules/joern/detect-validation.sc`
...
2. `joern <cpg.bin> --script .opencode/shared/security-audit/joern-rules/java/java-xpath-injection-detect-validation.sc`.
