# java-file-upload-locate-sources

- **language**: java
- **skill**: `java-file-upload`
- **weakness**: `file-upload`
- **dimension**: D5
- **source_script**: `skills/java-subagent/java-file-upload/rules/joern/locate-sources.sc`
...
2. `joern <cpg.bin> --script .opencode/shared/security-audit/joern-rules/java/java-file-upload-locate-sources.sc`.
