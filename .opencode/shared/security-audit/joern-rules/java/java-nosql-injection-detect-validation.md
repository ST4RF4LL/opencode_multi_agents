# java-nosql-injection-detect-validation

- **language**: java
- **skill**: `java-nosql-injection`
- **weakness**: `nosql-injection`
- **dimension**: D1
- **source_script**: `skills/java-subagent/java-nosql-injection/rules/joern/detect-validation.sc`
...
2. `joern <cpg.bin> --script .opencode/shared/security-audit/joern-rules/java/java-nosql-injection-detect-validation.sc`.
