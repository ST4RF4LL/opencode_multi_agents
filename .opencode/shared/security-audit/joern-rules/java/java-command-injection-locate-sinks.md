# java-command-injection-locate-sinks

- **language**: java
- **skill**: `java-command-injection`
- **weakness**: `command-injection`
- **dimension**: D1
- **source_script**: `skills/java-subagent/java-command-injection/rules/joern/locate-sinks.sc`
...
2. `joern <cpg.bin> --script .opencode/shared/security-audit/joern-rules/java/java-command-injection-locate-sinks.sc`.
