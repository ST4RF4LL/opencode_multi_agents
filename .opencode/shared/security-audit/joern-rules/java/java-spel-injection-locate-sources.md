# java-spel-injection-locate-sources

- **language**: java
- **skill**: `java-spel-injection`
- **weakness**: `spel-injection`
- **dimension**: D1
- **source_script**: `skills/java-subagent/java-spel-injection/rules/joern/locate-sources.sc`
...
2. `joern <cpg.bin> --script .opencode/shared/security-audit/joern-rules/java/java-spel-injection-locate-sources.sc`.
