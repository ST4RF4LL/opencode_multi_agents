# java-sql-injection-derived-raw-sql-execution

- **language**: java
- **skill**: `java-sql-injection`
- **weakness**: `sql-injection`
- **dimension**: D1
- **source_script**: `skills/java-subagent/java-sql-injection/rules/joern/derived/raw-sql-execution.sc`
...
2. `joern <cpg.bin> --script .opencode/shared/security-audit/joern-rules/java/java-sql-injection-derived-raw-sql-execution.sc`.
