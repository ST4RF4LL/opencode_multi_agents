...
// Original entry: @main def exec(cpgFile: String, sinkMethod: String = ".*Document\\.parse.*")
// Do not call importCpg; use the ambient `cpg` symbol.
// Extra param default inlined: sinkMethod: String = ".*Document\\.parse.*"

val sinkMethod = ".*Document\\.parse.*"
