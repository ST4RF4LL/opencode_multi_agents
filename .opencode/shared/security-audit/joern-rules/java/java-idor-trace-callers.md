# java-idor-trace-callers

- **language**: java
- **skill**: `java-idor`
- **weakness**: `idor`
- **dimension**: D3
- **source_script**: `skills/java-subagent/java-idor/rules/joern/trace-callers.sc`
...
2. `joern <cpg.bin> --script .opencode/shared/security-audit/joern-rules/java/java-idor-trace-callers.sc`.
