...
1. `security-intel-collector` freezes a Git-aware file scope, builds digest-cached function manifests from language-scoped source projections, emits a compact threat-routing index, and produces entry-point, sink, sensitive-operation, config-surface, and AI-surface inventories.
