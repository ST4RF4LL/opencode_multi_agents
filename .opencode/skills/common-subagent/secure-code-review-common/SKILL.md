...
5. The trusted structural artifact reports no missing, invalid, conflicting, parser, or scope-drift item; local audit-todo has no PENDING/RUNNING/FAILED item, and each DONE item has an accepted packet handoff and report.
