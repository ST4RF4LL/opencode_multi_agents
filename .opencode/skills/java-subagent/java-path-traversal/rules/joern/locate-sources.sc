// Locate common external input sources for path traversal / Zip Slip / multipart.
@main def exec(cpgFile: String) = {
  ...
  val annotated = cpg.parameter
    .where(_.annotation.name("RequestParam|PathVariable|RequestHeader|RequestBody|CookieValue|RequestPart"))
    .l
